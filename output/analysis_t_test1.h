...
// Mon Dec 12 10:58:44 2016 by ROOT version 5.34/21
// from TChain T/
//////////////////////////////////////////////////////////

#ifndef analysis_t_test1_h
#define analysis_t_test1_h
...
class analysis_t_test1 : public TSelector {
public :
  TH1F           *h1_mass_rho;
  TH1F           *h1_mass_rho_pi_pi;
  TH1F           *h1_q2;
  TH1F           *h1_t;
  TH1F           *h1_nu;
  ...
  TTree          *fChain;   //!pointer to the analyzed TTree or TChain
   ...
   analysis_t_test1(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~analysis_t_test1() { }
   ...
   ClassDef(analysis_t_test1,0);
};

#endif

#ifdef analysis_t_test1_cxx
void analysis_t_test1::Init(TTree *tree)
{
...
Bool_t analysis_t_test1::Notify()
{
...
#endif // #ifdef analysis_t_test1_cxx
