...
root -l -q -b run_analysis.C
./EdGen -i input_test.dat
root -l -q -b run_newAnalysis.C
./EdGen -i input_test5.dat
root -l -q -b run_analysis_5.C
./EdGen -i input_test6.dat
root -l -q -b run_analysis_6.C
./EdGen -i input_test7.dat
root -l -q -b run_analysis_7.C
./EdGen -i input_t_test1.dat
root -l -q -b run_analysis_t_test1.C
./EdGen -i input_t_test2.dat
root -l -q -b run_analysis_t_test2.C
./EdGen -i input_t_test3.dat
root -l -q -b run_analysis_t_test3.C
./EdGen -i input_t_test4.dat
root -l -q -b run_analysis_t_test4.C
