#define analysis_t_test3_cxx
// The class definition in analysis_t_test3.h has been generated automatically
...
//
// Root > T->Process("analysis_t_test3.C")
// Root > T->Process("analysis_t_test3.C","some options")
// Root > T->Process("analysis_t_test3.C+")
//

#include "analysis_t_test3.h"
#include <TH2.h>
#include <TStyle.h>


void analysis_t_test3::Begin(TTree * /*tree*/)
{
...
void analysis_t_test3::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t analysis_t_test3::Process(Long64_t entry)
{
   // The Process() function is called for each entry in the tree (or possibly
   // keyed object in the case of PROOF) to be processed. The entry argument
   // specifies which entry in the currently loaded tree is to be processed.
   // It can be passed to either analysis_t_test3::GetEntry() or TBranch::GetEntry()
  ...
  TLorentzVector p_fp2(px[2],py[2],pz[2],Ef[2]);
  TLorentzVector p_K0_1(px[3],py[3],pz[3],Ef[3]);
  TLorentzVector p_K0_2(px[4],py[4],pz[4],Ef[4]);
  TLorentzVector p_pip_1(px[5],py[5],pz[5],Ef[5]);
  TLorentzVector p_pim_1(px[6],py[6],pz[6],Ef[6]);
  TLorentzVector p_pip_2(px[7],py[7],pz[7],Ef[7]);
  TLorentzVector p_pim_2(px[8],py[8],pz[8],Ef[8]);
  ...
  h1_vz_K0_1->Fill(vz[3]);
  h1_vz_K0_2->Fill(vz[4]);
  h1_vz_piK0_1->Fill(vz[5]);
  h1_vz_piK0_2->Fill(vz[7]);


   return kTRUE;
}

void analysis_t_test3::SlaveTerminate()
{
...
void analysis_t_test3::Terminate()
{
   // The Terminate() function is the last function to be called during
   // a query. It always runs on the client, it can be used to present
   // the results graphically or save the results to file.
  TFile file_out("analysis_t_test3_output.root","recreate");
