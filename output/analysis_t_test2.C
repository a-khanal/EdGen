#define analysis_t_test2_cxx
// The class definition in analysis_t_test2.h has been generated automatically
...
//
// Root > T->Process("analysis_t_test2.C")
// Root > T->Process("analysis_t_test2.C","some options")
// Root > T->Process("analysis_t_test2.C+")
//

#include "analysis_t_test2.h"
#include <TH2.h>
#include <TStyle.h>


void analysis_t_test2::Begin(TTree * /*tree*/)
{
...
void analysis_t_test2::SlaveBegin(TTree * /*tree*/)
{
   ...
   h1_mass_a2  = new TH1F("h1_mass_a2","Mass a_{2}; GeV",200,0.,2.0);
...
Bool_t analysis_t_test2::Process(Long64_t entry)
{
   // The Process() function is called for each entry in the tree (or possibly
   // keyed object in the case of PROOF) to be processed. The entry argument
   // specifies which entry in the currently loaded tree is to be processed.
   // It can be passed to either analysis_t_test2::GetEntry() or TBranch::GetEntry()
  ...
  TLorentzVector p_pip(px[4],py[4],pz[4],Ef[4]);
  TLorentzVector p_pim(px[5],py[5],pz[5],Ef[5]);
  TLorentzVector p_pip2(px[7],py[7],pz[7],Ef[7]);
  TLorentzVector p_pim2(px[8],py[8],pz[8],Ef[8]);
  TLorentzVector p_pi0(px[6],py[6],pz[6],Ef[6]);
  TLorentzVector p_omega(px[3],py[3],pz[3],Ef[3]);
  ...
  double weight_v = weight[0] * weight[2] * weight[5];
  

  h1_mass_omega->Fill(p_omega.M(),weight_v);
  h1_mass_a2->Fill(p_a2.M(),weight_v);
...
void analysis_t_test2::SlaveTerminate()
{
...
void analysis_t_test2::Terminate()
{
   // The Terminate() function is the last function to be called during
   // a query. It always runs on the client, it can be used to present
   // the results graphically or save the results to file.
  TFile file_out("analysis_t_test2_output.root","recreate");
