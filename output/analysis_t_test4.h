...
// Mon Dec 12 15:09:14 2016 by ROOT version 5.34/21
// from TChain T/
//////////////////////////////////////////////////////////

#ifndef analysis_t_test4_h
#define analysis_t_test4_h
...
class analysis_t_test4 : public TSelector {
public :
  TH1F           *h1_mass_omega;
  ...
  TH1F           *h1_nu;
   ...
   analysis_t_test4(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~analysis_t_test4() { }
   ...
   ClassDef(analysis_t_test4,0);
};

#endif

#ifdef analysis_t_test4_cxx
void analysis_t_test4::Init(TTree *tree)
{
...
Bool_t analysis_t_test4::Notify()
{
...
#endif // #ifdef analysis_t_test4_cxx
