...
Double_t EdGenPhaseSpace::PDK(Double_t a, Double_t b, Double_t c) 
{
   //the PDK function
...
EdGenPhaseSpace::EdGenPhaseSpace(const EdGenPhaseSpace &gen) : TObject(gen)
{
   //copy constructor
   fNt      = gen.fNt;
   fWtMax   = gen.fWtMax;
...
//__________________________________________________________________________________________________
EdGenPhaseSpace& EdGenPhaseSpace::operator=(const EdGenPhaseSpace &gen)
{
   // Assignment operator
...
//__________________________________________________________________________________________________
Double_t EdGenPhaseSpace::Generate() 
{
...
Double_t EdGenPhaseSpace::Generate_t() 
{
   //  Generate a random final state but with a certain t shape for the electron.
   //  The function returns the weigth of the current event.
   //  The TLorentzVector of each decay product can be obtained using GetDecay(n).
   //
   // Note that Momentum, Energy units are Gev/C, GeV
...
TLorentzVector *EdGenPhaseSpace::GetDecay(Int_t n) 
{ 
...
//_____________________________________________________________________________________
Bool_t EdGenPhaseSpace::SetDecay(TLorentzVector &P, Int_t nt, 
